package com.brokencircuits.kissad.spshowfetch.streams;
...
public class StreamController extends StreamsService {
  ...
  private final SourceName acceptSource;
  ...
  protected Topology buildTopology() {
    ...
    KStream<ByteKey<ShowMsgKey>, ShowMsg>[] branches = showStream.branch(
        (key, msg) -> msg.getValue().getSources().containsKey(acceptSource.name()),
        (key, msg) -> true
    );
